...
extern mActor_name_t mPr_DummyPresentToTruePresent(void);
...
extern s16 mPr_GetMoneyPower(void);
extern s16 mPr_GetGoodsPower(void);
extern int mPr_CheckMuseumAddress(Private_c* priv);
extern int mPr_CheckMuseumInfoMail(Private_c* priv);
extern Private_c* mPr_GetForeignerP(void);
