...
static void _none_aIAB_INIT_PROC(aINS_INSECT_ACTOR* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
static void _none_aINS_ACTION_PROC(ACTOR* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
#endif

static void aIAB_setupAction(aINS_INSECT_ACTOR* insect, int action, GAME* game) {
    static aIAB_INIT_PROC init_proc[] = {
        _none_aIAB_INIT_PROC,
