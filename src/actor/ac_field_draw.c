...
static void _none_aFD_DRAW_PROC(GAME* _p0) { (void)_p0; }
#endif

static void aFD_DrawBlock(aFD_block_c* block, ACTOR* actorx, GAME* game) {
    static aFD_DRAW_PROC draw_proc[] = { _none_aFD_DRAW_PROC, &Global_kankyo_set_room_prim,
                                         &Global_kankyo_set_room_prim, _none_aFD_DRAW_PROC };
