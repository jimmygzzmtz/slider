...
static void _none_aEDZ_TALK_PROC(DOZAEMON_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEDZ_THINK_INIT_PROC(DOZAEMON_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEDZ_THINK_PROC(DOZAEMON_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
