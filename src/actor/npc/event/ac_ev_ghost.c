...
static void _none_aEGH_PROC(EV_GHOST_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEGH_TALK_PROC(EV_GHOST_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
