...
static void _none_aNPC_DRAW_AFTER_PROC(GAME* _p0, NPC_ACTOR* _p1, int _p2) { (void)_p0; (void)_p1; (void)_p2; }
static void _none_aNPC_DRAW_BEFORE_PROC(GAME* _p0, NPC_ACTOR* _p1, s_xyz* _p2, xyz_t* _p3) { (void)_p0; (void)_p1; (void)_p2; (void)_p3; }
