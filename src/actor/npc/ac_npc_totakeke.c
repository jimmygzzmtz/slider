...
#ifdef TARGET_PC
static void aNTT_schedule_proc(NPC_ACTOR* actorx, GAME_PLAY* play, int schedule_id);
...
static void _none_aNTT_PROC(NPC_TOTAKEKE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
