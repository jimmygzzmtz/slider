...
static void _none_aTTB_ACTION_PROC(TOOL_TUMBLER_ACTOR* _p0) { (void)_p0; }
#endif

static void aTTB_setupAction(TOOL_TUMBLER_ACTOR* tumbler_actor, int action) {
    static aTTB_ACTION_PROC process[] = { _none_aTTB_ACTION_PROC, &aTTB_takeout, &aTTB_putaway, &aTTB_destruct,
                                          _none_aTTB_ACTION_PROC, NULL };
