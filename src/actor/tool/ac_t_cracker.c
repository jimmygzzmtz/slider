...
static void _none_CRACKER_PROC(ACTOR* _p0) { (void)_p0; }
#endif

static void aTCR_setupAction(ACTOR* actor, int idx){
    CRACKER_ACTOR* cracker = (CRACKER_ACTOR*)actor;

    static CRACKER_PROC process[] = {_none_CRACKER_PROC, aTCR_takeout,aTCR_putaway,aTCR_destruct,
    _none_CRACKER_PROC,NULL};
