...
static void _none_PISTOL_PROC(ACTOR* _p0) { (void)_p0; }
#endif

static void aTPT_setupAction(ACTOR* actor, int idx){
    PISTOL_ACTOR* pistol = (PISTOL_ACTOR*)actor;

    static PISTOL_PROC process[] = {_none_PISTOL_PROC, aTPT_takeout,aTPT_putaway,aTPT_destruct,
    _none_PISTOL_PROC,NULL};
