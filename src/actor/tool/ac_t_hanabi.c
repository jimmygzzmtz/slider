...
static void _none_HANABI_PROC(ACTOR* _p0) { (void)_p0; }
#endif

static void aTHB_setupAction(ACTOR* actor, int idx) {
    HANABI_ACTOR* hanabi = (HANABI_ACTOR*)actor;

    static HANABI_PROC process[] = { _none_HANABI_PROC, aTHB_takeout, aTHB_putaway, aTHB_destruct,
                                     _none_HANABI_PROC, NULL };
