...
static void _none_mNW_OVL_PROC(Submenu* _p0, mSM_MenuInfo_c* _p1) { (void)_p0; (void)_p1; }
#endif

static void mNW_needlework_ovl_move(Submenu* submenu) {
    static mNW_OVL_PROC ovl_move_proc[] = {
        &mNW_move_Move, &mNW_move_Play, &mNW_move_Wait, _none_mNW_OVL_PROC, &mNW_move_End,
    };
