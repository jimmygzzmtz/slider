...
static void _none_mCL_ITEM_DRAW_PROC(mCL_Item_c* _p0, mSM_MenuInfo_c* _p1, GRAPH* _p2) { (void)_p0; (void)_p1; (void)_p2; }
static void _none_mCL_OVL_MOVE_PROC(Submenu* _p0, mSM_MenuInfo_c* _p1) { (void)_p0; (void)_p1; }
#endif
...
static void mCL_catalog_ovl_move(Submenu* submenu) {
    static mCL_OVL_MOVE_PROC ovl_move_proc[] = {
        &mCL_move_Move, &mCL_move_Play, _none_mCL_OVL_MOVE_PROC, _none_mCL_OVL_MOVE_PROC, mCL_move_End,
    };
...
static void mCL_item_draw(Submenu* submenu, mSM_MenuInfo_c* menu_info, GAME* game, GRAPH* graph, mCL_Item_c* item,
    ...
    static mCL_ITEM_DRAW_PROC draw_proc[mCL_DRAW_TYPE_NUM] = {
        _none_mCL_ITEM_DRAW_PROC, &mCL_paper_draw, &mCL_wall_draw, &mCL_carpet_draw, &mCL_music_draw,
    };
