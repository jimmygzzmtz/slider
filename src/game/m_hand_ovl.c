...
static void _none_mHD_OPEN_END_PROC(Submenu* _p0, int _p1, int _p2) { (void)_p0; (void)_p1; (void)_p2; }
static void _none_mHD_OVL_MOVE_PROC(Submenu* _p0) { (void)_p0; }
static void _none_mSM_HAND_DRAW_FUNC(Submenu* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
static void _none_mSM_HAND_MOVE_FUNC(Submenu* _p0) { (void)_p0; }
#endif
...
static void mHD_open_end_proc_item(Submenu* submenu) {
    static mHD_OPEN_END_PROC proc_table[] = {
        ...
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_MBOX */
        &mHD_open_end_proc_item_type6,  /* mTG_TABLE_HANIWA */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_COLLECT */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_WCHANGE */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPMAIL */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPMAIL_WC */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPMAIL_TI */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPEDIT */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPEDIT_END */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CATALOG */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CATALOG_WC */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_MUSIC_MAIN */
        &mHD_open_end_proc_item_type17, /* mTG_TABLE_NEEDLEWORK */
        &mHD_open_end_proc_item_type17, /* mTG_TABLE_CPORIGINAL */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_INVENTORY_WC_ORG */
        &mHD_open_end_proc_item_type17, /* mTG_TABLE_CPORIGINAL_NW */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPORIGINAL_WC */
        _none_mHD_OPEN_END_PROC, /* mTG_TABLE_CPORIGINAL_TI */
...
static void mHD_nop_hand_func(Submenu* submenu) {
    submenu->overlay->menu_control.hand_move_func = _none_mSM_HAND_MOVE_FUNC;
    submenu->overlay->menu_control.hand_draw_func = _none_mSM_HAND_DRAW_FUNC;
}
