...
static void _none_SUBMENU_GAME_PROC(Submenu* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
static void _none_SUBMENU_PROC(Submenu* _p0) { (void)_p0; }
...
static void _none_mSM_TAG_DRAW_FUNC(Submenu* _p0, GAME* _p1, int _p2) { (void)_p0; (void)_p1; (void)_p2; }
static void _none_mSM_TAG_MOVE_FUNC(Submenu* _p0, mSM_MenuInfo_c* _p1) { (void)_p0; (void)_p1; }
#endif
...
static void mSM_return_func(Submenu* submenu, mSM_MenuInfo_c* menu_info) {
    if (menu_info->next_menu_type != mSM_OVL_NONE) {
        ...
        if (submenu->menu_type == mSM_OVL_NONE) {
            ...
            submenu->move_proc = _none_SUBMENU_PROC;
            submenu->current_menu_type = menu_info->pre_menu_type;
            submenu->overlay->menu_control.menu_move_func = _none_SUBMENU_PROC;
            submenu->overlay->menu_control.menu_draw_func = _none_SUBMENU_GAME_PROC;
            emu64_refresh();
        } else {
...
extern void mSM_menu_ovl_init(Submenu* submenu) {
    ...
    control->menu_move_func = _none_SUBMENU_PROC;
    control->menu_draw_func = _none_SUBMENU_GAME_PROC;
    control->hand_move_func = _none_mSM_HAND_MOVE_FUNC;
    control->hand_draw_func = _none_mSM_HAND_DRAW_FUNC;
    control->tag_move_func = _none_mSM_TAG_MOVE_FUNC;
    control->tag_draw_func = _none_mSM_TAG_DRAW_FUNC;
