...
static void _none_mCW_OVL_PROC(Submenu* _p0, mSM_MenuInfo_c* _p1) { (void)_p0; (void)_p1; }
#endif

static void mCW_cpwarning_ovl_move(Submenu* submenu) {
    static mCW_OVL_PROC ovl_move_proc[] = {
        &mCW_move_Move, &mCW_move_Play, _none_mCW_OVL_PROC, _none_mCW_OVL_PROC, &mCW_move_End,
    };
